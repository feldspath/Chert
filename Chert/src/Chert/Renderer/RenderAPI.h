...
namespace chert {
    ...
    public:
        ...
        static inline void drawIndexed(std::shared_ptr<VertexArray>& vertexArray) { instance->drawIndexedImpl(vertexArray); }
        static void init();

    protected:
        virtual void setClearColorImpl(const glm::vec4& color) = 0;
        virtual void clearImpl() = 0;
        virtual void drawIndexedImpl(std::shared_ptr<VertexArray>& vertexBuffer) = 0;
